...
//!
//! Every source of music (`YouTube`, `SoundCloud`, Jamendo, Internet Archive,
//! `MusicBrainz`, …) is described by a [`ProviderId`] plus a small set of
//! capability flags and per-provider operations. Tracks keep a
//! [`crate::types::providers`]-scoped map of provider-specific identifiers,
